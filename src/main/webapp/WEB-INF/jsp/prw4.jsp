<%-- 
    Document   : prw4
    Created on : 20-Apr-2023, 11:00:05 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
            ...
            <h3></h3>Research entails the folowing steps:</h3>
  ...
  <div class="second">
    <p>
        <ol>
            <br>
            <li>Posing a question
            </li>
            <li>Developing a procedure to answer that question
            </li>
            <li>Follow the procedure to make appropriate empirical observations
            </li>
            <li>Rationally interpret the empirical observation to arrive at a conclusion.
            </li>
  ...
  <div class="imgtag">
    <img src="https://www.sinequa.com/wp-content/uploads/blog/investigative-research-960.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw5' ">Next</button>
