<%-- 
    Document   : ethics13
    Created on : 03-May-2023, 7:10:27 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
    <p>
2.	Handling ethical conflicts and dilemmas: When faced with an ethical conflict or dilemma, engineers should seek input from colleagues, professional organizations, and other resources to help them make a well-informed decision. It is important for engineers to approach ethical conflicts and dilemmas in a thoughtful and rational manner, and to avoid making decisions based on personal biases or interests.

    </p>
  </div>
  <div class="second">
   <p>   
3.	Building a culture of ethics in engineering organizations: Engineering organizations can promote ethical behavior by establishing codes of ethics, providing ethics training and education to employees, and creating a culture that values integrity and accountability. It is important for organizations to foster an environment where employees feel comfortable raising ethical concerns and reporting potential violations.
  </p>
  </div>
...
<div class="imgtag">
  <img src="https://etimg.etb2bimg.com/photo/90013647.cms" alt="image">

</div>

  
  </div>
<button class="next" onclick="window.location.href = 'ethics14'">Next</button>
