<%-- 
    Document   : plagiarism7
    Created on : 16-Mar-2023, 4:16:16 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
        Collusion: What is permitted 
        <ul>
            <br>
            <li>Discussion on any idea or thought among a group, but writing it independently.</li>
            <br>
            <li>Reading textbooks, online resources together.</li>
            <br>
            <li>Discussion on assignments once it is submitted , for any feedback.</li>
        </ul>
  </div>
  <div class="second">
    <p>
        Collusion: what is not permitted
        <ul>
            <br>
            <li>Allowing your friends to copy your assignment.</li>
            <br>
            <li>Borrowing other's submission without his/her consent.</li>
        </ul>
  </div>
...
<button class="next" onclick="window.location.href = 'ptest4'">Next</button>
