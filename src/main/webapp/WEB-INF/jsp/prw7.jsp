<%-- 
    Document   : prw7
    Created on : 20-Apr-2023, 11:00:57 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="second">
    <p>
        <ul>
            <br>
            <li>Will you be able to tackle the problems associated with the project? </li>
            <li>Will this project area compel a large number of investors to buy this project.  </li>
            <li>The problems should be approached with maturity.</li>
            <li>Beware of going to the opposite extreme in the future.</li>
        </ul>
  </div>
  
</div>
  <div class="imgtag">
    <img src="https://mlxxbzhxjbpm.i.optimole.com/w:auto/h:auto/q:mauto/https://i0.wp.com/scholarpreneurs.com/wp-content/uploads/2018/01/wordcloud-e1516027687378.jpg?fit=1500%2C965&ssl=1" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'pwtest3' ">Next</button>
