<%-- 
    Document   : plagiarism6
    Created on : 16-Mar-2023, 4:16:06 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
    <p>
        Collusion is the form of plagiarism which two or more persons collaborate to produce a piece of work together with the intention to deceive one who checks it.
    </p>
  </div>
  <div class="second">
    <p>
        A student will be considered to have colluded if they do any of the following: 
        <ul>
            <br>
            <li>Obtain another student's work through any means and present it as their own, in whole or in part.</li>
            <br>
            <li>Permit any of their own work to be obtained by another student for later submission as that student's own work.</li>
        </ul>
  </div>
  
</div>
  <div class="imgtag">
    <img src="https://www.latrobe.edu.au/students/study-resources/learning/allu-images/Students-studying-around-table.jpg/large.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'plagiarism7'">Next</button>
