<%-- 
    Document   : plagiarism5
    Created on : 16-Mar-2023, 9:38:04 am
    Author     : Tanya
--%>
...
<div class="box">
  <h1>What Doesn't Need to Be Cited?</h1>
  <div class="section">
  <div class="text">
  <div class="first">
    <p>
        Your own work that has not been previously published or submitted elsewhere does not need to be cited.
    </p>
  </div>
  <div class="second">
    <p>
        Common knowledge or universal Knowledge does not need to be cited. Common knowledge includes facts that are known by a lot of people and can be found in many sources. For example, you do not need to cite the following:
        <ul>
            <br>
            <li>Abraham Lincoln was the 16th President of the United States.</li>
            <br>
            <li>The Big Bang theory posits that the universe began billions of years ago with an enormous explosion.</li>
        </ul>
  </div>
  
</div>
  <div class="imgtag">
    <img src="https://s35691.pcdn.co/wp-content/uploads/2018/04/student-using-laptop-library-id513231810-180416.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'ptest3'">Next</button>
