<%-- 
    Document   : prw10
    Created on : 18-May-2023, 10:31:10 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
            ...
            <br>
            <br>
            <h3>Given an idea, need to determine:
            </h3>
            <ul>
              <li>What similar work has been done leading up to this point?</li>
              <li>Has this work been done previously? </li>
              <li>How is any previous work distinguished from what I?m planning to do?
              </li>
              <li>What group of people will be positively impacted by the research?
              </li>
            </ul>
  ...
  <div class="imgtag">
    <img src="https://contenthub-static.grammarly.com/blog/wp-content/uploads/2021/09/literature-review.jpeg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw11'">Next</button>
