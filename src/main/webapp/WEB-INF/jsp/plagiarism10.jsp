<%-- 
    Document   : plagiarism10
    Created on : 16-Apr-2023, 1:24:13 pm
    Author     : Tanya
--%>
...
<div class="box">
  <h1>Avoiding collusion and protecting your assessment</h1>
  <div class="section">
  <div class="text">
  ...
  <div class="second">
    <p> 
        <ul>
            <li>Do not give your assessment work to another student </li>
            <li>Do not ask another student for a copy of their assessment </li>
            <li>If you are working at office, college or any other public place , always protect your work with password and  save your work at the time of leaving.</li>
        </ul>
  </div>
  
</div>
  <div class="imgtag">
    <img src="https://www.tablestewards.com/wp-content/uploads/elementor/thumbs/Collaborate-1-pl0e6u08dl2x4vmuey6id2kyyi896a8kqqz3o0jdl4.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'ptest7'">Next</button>
