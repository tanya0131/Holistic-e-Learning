<%-- 
    Document   : etest1
    Created on : 11-May-2023, 9:40:31 am
    Author     : Tanya
--%>
...
<body>
    <div class="paper">
       ...
       <div class=buttons>
        <button class="btn" onclick="window.location.href = 'ethics1'">Prev</button>
        <button id="next-btn" class="btn">Next</button>
        <button id="next-top" class="btn" onclick="window.location.href='ethics3'">Next Topic</button>
       </div>
...
const questions =[{
        question:"Which of the following best describes the difference between ethics and morality?",
        answers:[
            {text:"Ethics refers to a broader set of principles than morality.",correct:false},
            {text:"Morality refers to a specific set of principles for a particular context, while ethics refers to a broader set of principles that guide behavior in general.",correct:true},
            {text:"Ethics and morality are interchangeable terms.",correct:false},
        ]
        },
        {
