<%-- 
    Document   : prw12
    Created on : 18-May-2023, 10:31:35 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
            ...
            <br>
            <br>
            <h3>A literature review considers 
            </h3>
            <ul>
              <li>the critical points of current knowledge 
            </li>
            <li>
  ...
  <div class="imgtag">
    <img src="/p16img.png" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw13' ">Next</button>
