<%-- 
    Document   : prw3
    Created on : 20-Apr-2023, 10:59:55 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="second">
    <p>
        <ul><pre>
            ...
            <li>TENACITY:    It has always been so </li>
            <li>INTUTION:    I feel it is so </li>
            <li>AUTHORITY:   They say it is so</li>
            <li>RATIONALISM: It makes sense for it to be so</li>
            <li>EMPIRICISM:  Data suggests it to be so</li>
            <li>SCIENCE:     It can be demonstrated to be so</li>
            </pre>
        </ul>
  </div>
  ...
  <div class="imgtag">
    <img src="https://media.licdn.com/dms/image/C5612AQEOEtIbQBE_Gw/article-cover_image-shrink_600_2000/0/1561858492162?e=2147483647&v=beta&t=oBmAfaduIDeHoHpy-KLAnG7qzAHNxOmGXCh9NFnM7iU" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'pwtest1'">Next</button>
