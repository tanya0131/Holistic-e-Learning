<%-- 
    Document   : prw6
    Created on : 20-Apr-2023, 11:00:32 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="second">
    <p>
        <ul>
            <br>
            <li>Pick the problem you are enthusiastic about </li>
            <li>Choose a projecxt that will interest you over the long haul. </li>
            <li>The project should be completed in a stipulated period of time</li>
            <li>Will it lead to other research problems?
            </li>
        </ul>
  </div>
  ...
  <div class="imgtag">
    <img src="https://analysistabs.com/wp-content/uploads/2022/06/How-to-Name-A-Project-Title.png" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw7'">Next</button>
