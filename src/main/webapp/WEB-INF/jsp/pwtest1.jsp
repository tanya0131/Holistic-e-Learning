<%-- 
    Document   : pwtest1
    Created on : 20-Apr-2023, 11:15:28 pm
    Author     : Tanya
--%>
...
<body>
    <div class="paper">
       ...
       <div class=buttons>
        <button class="btn" onclick="window.location.href = 'prw3'">Prev</button>
        <button id="next-btn" class="btn">Next</button>
        <button id="next-top" class="btn" onclick="window.location.href='prw4'">Next Topic</button>
       </div>
...
const questions =[{
        question:"The word Empiricism means?",
        answers:[
            {text:"It can be demonstrated to be so ",correct:false},
            {text:"Data does not suggests it to be so",correct:false},
            {text:"They say it is so",correct:false},
            {text:"Data suggests it to be so",correct:true},
        ]
        }
