<%-- 
    Document   : prw9
    Created on : 20-Apr-2023, 11:32:04 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
        <br><br>
        To acquire such skills you will need:
     </p>
  </div>
  <div class="second">
    <p>
        <ul>
            <br>
            <li>Direct access or web access to courses and seminars </li>
            <li>Library materials </li>
            <li>Study opportunities</li>
            <li>Other students, researcher, faculty members, and even industrial scientists and engineers
            </li>
  ...
  <div class="imgtag">
    <img src="https://d1whtlypfis84e.cloudfront.net/guides/wp-content/uploads/2018/03/26114007/Project-Management-Plan.jpeg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'pwtest4'">Next</button>
