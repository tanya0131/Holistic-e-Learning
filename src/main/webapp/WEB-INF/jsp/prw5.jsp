<%-- 
    Document   : prw5
    Created on : 20-Apr-2023, 11:00:14 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
        <ul>
            <br>
            <li>It is really important to do the right research as well as to do the research right
            </li>
            <li>It is really important to do the right research as well as to do the research right
            </li>
        </ul>
  ...
  <div class="second">
    <p>
        <ul>
            <br>
            <li>The right topic will be interesting to you, complex, and compelling
            </li>
            <li>The most successful research topics are narrowly focused and carefully defined but are important part of broad-ranging, complex problem
            </li>
  ...
  <div class="imgtag">
    <img src="https://leverageedublog.s3.ap-south-1.amazonaws.com/blog/wp-content/uploads/2020/03/28214113/Types-of-Research-Design-1024x640.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'pwtest2' ">Next</button>
