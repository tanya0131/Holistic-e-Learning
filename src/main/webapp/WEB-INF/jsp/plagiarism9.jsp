<%-- 
    Document   : plagiarism9
    Created on : 17-Mar-2023, 12:31:53 am
    Author     : Tanya
--%>
...
<div class="box">
  <h1>How To Avoid Unintentional Plagiarism</h1>
  <div class="section">
  <div class="text">
  <div class="first">
    <p>
  ...
  <div class="second">
    <p>
      <ul>
        <li>The correct citation to Give your work.</li>
        <li>Use online plagiarism detector for your work.</li>
        <li>Plan your assignment: This refers to balance your ideas with other sources evenly.</li>
        <li>Know how to paraphrase: Your writing is not a valid paraphrase just because you have changed a few words in the original sentences. You must modify the original's language and sentence structure while leaving the substance intact.</li>
      </ul>
    </p>
  </div>
  ...
  <div class="imgtag">
    <img src="https://bozemanmagazine.com/uploads/image/post/110/169/110169/header_1080x/16041_screen_shot_2021_03_05_at_10_26_47_am.png" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'ptest6'">Next</button>
