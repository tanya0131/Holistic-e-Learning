<%-- 
    Document   : pcertificate
    Created on : 20-Apr-2023, 7:58:17 pm
    Author     : Tanya
--%>
            ...
            <div class="col-xs-12">
              <div class="row">
                ...
                <div class="pm-earned col-xs-8 text-center">
                  <span class="pm-earned-text padding-0 times new roman">has successfully completed the course Plagiarism</span>
