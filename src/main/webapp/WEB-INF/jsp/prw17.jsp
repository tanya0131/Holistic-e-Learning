<%-- 
    Document   : prw17
    Created on : 18-May-2023, 10:41:20 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="imgtag">
    <img src="https://thumbs.dreamstime.com/b/book-sad-face-speech-bubble-line-icon-bad-literature-review-negative-feedback-symbol-book-sad-face-speech-bubble-176708866.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'pwtest5' ">Next</button>
