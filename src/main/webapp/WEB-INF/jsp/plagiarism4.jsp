<%-- 
    Document   : plagiarism4
    Created on : 16-Mar-2023, 9:36:15 am
    Author     : Tanya
--%>
...
<div class="box">
  <h1>Types of Plagiarism</h1>
  <div class="section">
  <div class="text">
  <div class="first">
    <p>
      4.	Self or auto plagiarism- reusing our own work in other work is known as self-plagiarism.
    </p>
  </div>
  <div class="second">
    <p>
      5.	Paraphrasing plagiarism- It is the most used plagiarism form we often use. It is encountered when we reuse another’s work and changes a few words or phrases.
    </p>
  </div>
  <div class="Third">
    <p>
      6.	Mosaic plagiarism- when we find synonyms for author’s language while keeping to the same general structure and meaning of the original work.
    </p>
  </div>
      <div class="Third">
    <p>
      7.	Accidental plagiarism- it is seen when we forgot to cite sources in our work.
    </p>
  </div>
</div>
  <div class="imgtag">
    <img src="https://pickardproperties.co.uk/wp-content/uploads/2021/03/female-student-studying-laptop.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'plagiarism5'">Next</button>
