<%-- 
    Document   : plagiarism1
    Created on : 15-Mar-2023, 11:14:16 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
    <p>
      Plagiarism is the representation of another author’s language, thoughts, ideas, or expressions as our own original work.
    </p>
  </div>
  <div class="second">
    <p>
      Plagiarism is considered academic dishonesty and an obligation of journalistic ethics.
    </p>
  </div>
  <div class="Third">
    <p>
      So, in simple words, it is the act of copying other’s work.
    </p>
  </div>
</div>
  <div class="imgtag">
    <img src="http://photos.demandstudios.com/getty/article/154/199/200394128-001.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'ptest1'">Next</button>
