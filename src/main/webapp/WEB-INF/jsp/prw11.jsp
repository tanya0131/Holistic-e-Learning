<%-- 
    Document   : prw11
    Created on : 18-May-2023, 10:31:21 pm
    Author     : Tanya
--%>
<!DOCTYPE html>
<html lang="en">
...
<div class="box">
  ...
  <div class="first">
     <p>
            ...
            <br>
            <ul>
              <li>Academic Players in India
            </li>
              <li>International Academic Players
            </li>
              <li>Industry Players
              </li>
              <li>Other Related Contributors and Sources </li>
            </ul>
  ...
  <div class="imgtag">
    <img src="https://afribary.com/blog/wp-content/uploads/2015/06/literature-review-1-728.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw12' ">Next</button>
