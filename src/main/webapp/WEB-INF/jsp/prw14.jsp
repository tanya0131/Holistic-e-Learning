<%-- 
    Document   : prw14
    Created on : 18-May-2023, 10:38:30 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
            ...
            <br>
            <ul>
              <li>The accepted facts in the area 
            </li>
              <li>The popular opinion 
            </li>
              <li>The main variables 
              </li>
              <li>The relationship between concepts and variables 
            </li>
              <li>Shortcomings in the existing findings</li>
              <li>Limitations in the methods used in the existing findings 
            </li>
            <li>The relevance of your research </li>
            <li>Suggestions for further research in the area. 
            </li>
  ...
  <div class="imgtag">
    <img src="https://images.squarespace-cdn.com/content/v1/606f09be9fd45e6380f33b68/c94eb426-a9e6-426d-a04a-bb042824a972/GettyImages-1357763912.jpg" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw15' ">Next</button>
