<%-- 
    Document   : etest2
    Created on : 11-May-2023, 9:40:52 am
    Author     : Tanya
--%>
...
<body>
    <div class="paper">
       ...
       <div class=buttons>
        <button class="btn" onclick="window.location.href = 'ethics4'">Prev</button>
        <button id="next-btn" class="btn">Next</button>
        <button id="next-top" class="btn" onclick="window.location.href='ethics5'">Next Topic</button>
       </div>
...
const questions =[{
        ...
        {
        question:"Which of the following is an ethical issue that may arise when balancing the needs of different stakeholders?",
        answers:[
            {text:"Neglecting the needs of marginalized communities.",correct:true},
            {text:"Choosing materials that meet safety standards, even if they are more expensive.",correct:false},
            {text:"Prioritizing public safety over other considerations.",correct:false},
        ]
        }
        ];  
