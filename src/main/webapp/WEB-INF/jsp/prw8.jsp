<%-- 
    Document   : prw8
    Created on : 20-Apr-2023, 11:31:56 pm
    Author     : Tanya
--%>
  ...
  <div class="second">
    <p>
        <ul>
            ...
            <li>Planning of Research Processes </li>
            <li>Planning of Developing New Skills</li>
            <li>Planning of Presentations</li>
        </ul>
  </div>
  
</div>
  <div class="imgtag">
    <img src="https://blog.vantagecircle.com/content/images/2021/06/Performance-Planning.png" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw9' ">Next</button>
