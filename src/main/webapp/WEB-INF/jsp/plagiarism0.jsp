<%-- 
    Document   : plagiarism0
    Created on : 15-Mar-2023, 11:37:05 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
    <p>
        In this course you will learn about plagiarism. We will be focusing on its forms, consequences and how to avoid it.
    </p>
  </div>
</div>
  <div class="imgtag">
    <img src="https://s3-us-east-2.amazonaws.com/maryville/wp-content/uploads/2019/01/09101756/Plagarism-768x512.jpg" alt="image">

  </div>

  
</div>
  <button class="next"><a href="plagiarism1">Let's Start</a></button>
