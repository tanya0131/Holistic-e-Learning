<%-- 
    Document   : pwtest2
    Created on : 20-Apr-2023, 11:16:28 pm
    Author     : Tanya
--%>
...
<body>
    <div class="paper">
       ...
       <div class=buttons>
        <button class="btn" onclick="window.location.href = 'prw5'">Prev</button>
        <button id="next-btn" class="btn">Next</button>
        <button id="next-top" class="btn" onclick="window.location.href='prw6'">Next Topic</button>
       </div>
...
const questions =[{
        question:"Is posing a question a part of research?",
        answers:[
        ...
        answers:[
            {text:"do the right research", correct:false},
            {text:"do the research right",correct:false},
            {text:"identify the right research area",correct:false},
