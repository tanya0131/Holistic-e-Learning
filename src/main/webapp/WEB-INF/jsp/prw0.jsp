<%-- 
    Document   : prw0
    Created on : 20-Apr-2023, 4:37:33 pm
    Author     : Tanya
--%>
...
<div class="contents">
  <ul class="list">
    <li><h1><a href="prw1"> Intoduction </a></h1></li>
    ...
    <li><h1><a href="prw12">Core Work</a></h1></li>
...
<button class="next" onclick="window.location.href = 'prw1'">Next</button>
