<%-- 
    Document   : prw15
    Created on : 18-May-2023, 10:38:40 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
            ...
            <br>
            <ul>
              <li>Searching for literature
            </li>
              <li>Sorting and prioritizing the retrieved literature</li>
              <li> Analytical reading of papers
              </li>
              <li>Evaluative reading of papers</li>
              <li>Comparison across studies</li>
              <li>Organizing the content</li>
            <li> Writing the review            </li>
            <li>Concept Map : Link between ideas and processes</li>
            <li>Tree Construction : Classification of topic in subthemes
            </li>
  ...
  <div class="imgtag">
    <img src="https://media.istockphoto.com/id/1214281726/vector/book-festival-concept-vector-flat-style-design-illustration.jpg?s=612x612&w=0&k=20&c=3u-LFpwpSebeVeXILbYbNWzqUW8vjkRDIQZm9nkljqA=" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw16' ">Next</button>
