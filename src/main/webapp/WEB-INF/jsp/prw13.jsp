<%-- 
    Document   : prw13
    Created on : 18-May-2023, 10:31:44 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <h2>Purpose of writting Literature Review</h2>
  <div class="section">
  <div class="text">
  <div class="first">
     <p>
            ...
            <ul>
              ...
              <li>Understanding the structure of the subject
              </li>
              <li>Relating ideas and theory to applications</li>
              <li>Identifying methodologies and techniques that have been used</li>
              <li>Placing the research in a historical context to show familiarity with state-of-the-art developments.
            </li>
...
<button class="next" onclick="window.location.href = 'prw14' ">Next</button>
