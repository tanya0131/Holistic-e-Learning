<%-- 
    Document   : prw2
    Created on : 20-Apr-2023, 10:59:44 pm
    Author     : Tanya
--%>
...
<div class="box">
  ...
  <div class="first">
     <p>
            ...
            <br>
            <br>
            <h3></h3>Human Kind needs to know</h3>
  ...
  <div class="imgtag">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFJK5X7Fgwx-7YoaYFu97kJ9wXevfr8_7TyQ&usqp=CAU" alt="image">

  </div>

  
</div>
<button class="next" onclick="window.location.href = 'prw3'">Next</button>
