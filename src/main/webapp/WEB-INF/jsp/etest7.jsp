<%-- 
    Document   : etest7
    Created on : 11-May-2023, 9:41:32 am
    Author     : Tanya
--%>
...
<body>
    <div class="paper">
       ...
       <div class=buttons>
        <button class="btn" onclick="window.location.href = 'ethics14'">Prev</button>
        <button id="next-btn" class="btn">Next</button>
        <button id="next-top" class="btn" onclick="window.location.href='efinal'">final quiz</button>
       </div>
...
const questions =[{
        ...
        {
        question:"When faced with an ethical conflict or dilemma, what is an important step for engineers to take?",
        answers:[
            {text:"Avoid seeking input from colleagues and professional organizations.",correct:false},
            {text:"Make a decision based on personal biases or interests.",correct:false},
            {text:"Approach the conflict or dilemma in a thoughtful and rational manner.",correct:true},
            {text:"Ignore the potential consequences of different courses of action.",correct:false},
        ]
        }
        ];  
